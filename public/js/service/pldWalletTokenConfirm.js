...
angular.module('wallletApp', []).controller('walletCtrl', function ($scope, $http, $timeout) {
    ...
    $scope.$watch('$viewContentLoaded', function () {
        $scope.privateKey = "L1tYc78wUxysGRjJR7kY2qWDSzXytuRRyvCo65MJRQPGGx8JePHG";
        $scope.address = "U1BFtK3uoeSajpMaa3SkdtRWabN326DST1p";
    });
    ...
    $scope.confirm = function () {
        ...
        if (flag) {
            ...
            $http({
                ...
                method: 'POST',
                data: sendData,
                url: './v1/pureland/pldWalletTokenConfirm'
