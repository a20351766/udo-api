	...
	try {
		...
		for (var i in proposalResponses) {
			...
			if (proposalResponses && proposalResponses[i].response &&
				...
				if (proposalResponses[i].message) {
					logger.error('install proposal was bad %j', proposalResponses[i].message);
				} else {
					logger.error('install proposal was bad %j', proposalResponses[i]);
				}
			}
